...
(function (a, b, c) {
    ...
    (function (a, b, d) {
        ...
        var d = Array.prototype.slice, e = b.cleanData;
        b.cleanData = function (a) {
            ...
            var e, f, g, h, i = a.split(".")[0];
            a = a.split(".")[1], e = i + "-" + a, d || (d = c, c = b.Widget), b.expr[":"][e] = function (a) {
                return!!b.data(a, e)
            }, b[i] = b[i] || {}, f = b[i][a], g = b[i][a] = function (a, b) {
                if (!this._createWidget)return new g(a, b);
                arguments.length && this._createWidget(a, b)
            }, b.extend(g, f, {version:d.version, _proto:b.extend({}, d), _childConstructors:[]}), h = new c, h.options = b.widget.extend({}, h.options), b.each(d, function (a, e) {
                b.isFunction(e) && (d[a] = function () {
                    var b = function () {
                    ...
                    return function () {
                        ...
                        return this._super = b, this._superApply = d, f = e.apply(this, arguments), this._super = a, this._superApply = c, f
                    }
                }())
            }), g.prototype = b.widget.extend(h, {widgetEventPrefix:a}, d, {constructor:g, namespace:i, widgetName:a, widgetBaseClass:e, widgetFullName:e}), f ? (b.each(f._childConstructors, function (a, c) {
                var d = c.prototype;
                b.widget(d.namespace + "." + d.widgetName, g, c._proto)
            }), delete f._childConstructors) : c._childConstructors.push(g), b.widget.bridge(a, g)
        }, b.widget.extend = function (a) {
            var e = d.call(arguments, 1), f = 0, g = e.length, h, i;
            for (; f < g; f++)for (h in e[f])i = e[f][h], e[f].hasOwnProperty(h) && i !== c && (a[h] = b.isPlainObject(i) ? b.widget.extend({}, a[h], i) : i);
            return a
        }, b.widget.bridge = function (a, e) {
            var f = e.prototype.widgetFullName;
            b.fn[a] = function (g) {
                var h = typeof g == "string", i = d.call(arguments, 1), j = this;
                return g = !h && i.length ? b.widget.extend.apply(null, [g].concat(i)) : g, h ? this.each(function () {
                    var d = b.data(this, f);
                    if (!d)return b.error("cannot call methods on " + a + " prior to initialization; " + "attempted to call method '" + g + "'");
                    if (!b.isFunction(d[g]) || g.charAt(0) === "_")return b.error("no such method '" + g + "' for " + a + " widget instance");
                    var e = d[g].apply(d, i);
                    if (e !== d && e !== c)return j = e && e.jquery ? j.pushStack(e.get()) : e, !1
                }) : this.each(function () {
                    var a = b.data(this, f);
                    a ? a.option(g || {})._init() : new e(g, this)
                }), j
            }
        }, b.Widget = function (a, b) {
        }, b.Widget._childConstructors = [], b.Widget.prototype = {widgetName:"widget", widgetEventPrefix:"", defaultElement:"<div>", options:{disabled:!1, create:null}, _createWidget:function (a, c) {
            c = b(c || this.defaultElement || this)[0], this.element = b(c), this.options = b.widget.extend({}, this.options, this._getCreateOptions(), a), this.bindings = b(), this.hoverable = b(), this.focusable = b(), c !== this && (b.data(c, this.widgetName, this), b.data(c, this.widgetFullName, this), this._bind({remove:"destroy"}), this.document = b(c.style ? c.ownerDocument : c.document || c), this.window = b(this.document[0].defaultView || this.document[0].parentWindow)), this._create(), this._trigger("create", null, this._getCreateEventData()), this._init()
            ...
            if (typeof a == "string") {
                e = {}, f = a.split("."), a = f.shift();
                if (f.length) {
                    g = e[a] = b.widget.extend({}, this.options[a]);
                    for (h = 0; h < f.length - 1; h++)g[f[h]] = g[f[h]] || {}, g = g[f[h]];
                    a = f.pop();
                    if (d === c)return g[a] === c ? null : g[a];
                    g[a] = d
                } else {
                    if (d === c)return this.options[a] === c ? null : this.options[a];
                    e[a] = d
                }
            }
            ...
            d ? (c = b(c), this.bindings = this.bindings.add(c)) : (d = c, c = this.element);
            var e = this;
            b.each(d, function (d, f) {
                function g() {
                    if (e.options.disabled === !0 || b(this).hasClass("ui-state-disabled"))return;
                    return(typeof f == "string" ? e[f] : f).apply(e, arguments)
                }

                typeof f != "string" && (g.guid = f.guid = f.guid || g.guid || a.guid++);
                var h = d.match(/^(\w+)\s*(.*)$/), i = h[1] + "." + e.widgetName, j = h[2];
                j ? e.widget().delegate(j, i, g) : c.bind(i, g)
            })
        }, _delay:function (a, b) {
            function c() {
            ...
            this.hoverable = this.hoverable.add(a), this._bind(a, {mouseenter:function (a) {
                b(a.currentTarget).addClass("ui-state-hover")
            }, mouseleave:function (a) {
                b(a.currentTarget).removeClass("ui-state-hover")
            }})
        }, _focusable:function (a) {
            this.focusable = this.focusable.add(a), this._bind(a, {focusin:function (a) {
                b(a.currentTarget).addClass("ui-state-focus")
            }, focusout:function (a) {
                b(a.currentTarget).removeClass("ui-state-focus")
            }})
        }, _trigger:function (a, c, d) {
            var e, f, g = this.options[a];
            d = d || {}, c = b.Event(c), c.type = (a === this.widgetEventPrefix ? a : this.widgetEventPrefix + a).toLowerCase(), c.target = this.element[0], f = c.originalEvent;
            if (f)for (e in f)e in c || (c[e] = f[e]);
            return this.element.trigger(c, d), !(b.isFunction(g) && g.apply(this.element[0], [c].concat(d)) === !1 || c.isDefaultPrevented())
        }}, b.each({show:"fadeIn", hide:"fadeOut"}, function (a, c) {
            b.Widget.prototype["_" + a] = function (d, e, f) {
                typeof e == "string" && (e = {effect:e});
                var g, h = e ? e === !0 || typeof e == "number" ? c : e.effect || c : a;
                e = e || {}, typeof e == "number" && (e = {duration:e}), g = !b.isEmptyObject(e), e.complete = f, e.delay && d.delay(e.delay), g && b.effects && (b.effects.effect[h] || b.uiBackCompat !== !1 && b.effects[h]) ? d[a](e) : h !== a && d[h] ? d[h](e.duration, e.easing, f) : d.queue(function (c) {
                    b(this)[a](), f && f.call(d[0]), c()
                })
            }
        }), b.uiBackCompat !== !1 && (b.Widget.prototype._getCreateOptions = function () {
        ...
        var e = "ontouchend"in c, f = "touchmove scroll", g = e ? "touchstart" : "mousedown", h = e ? "touchend" : "mouseup", i = e ? "touchmove" : "mousemove";
        ...
        var e = a(b), f = a("html"), g = a("head"), h = {urlParseRE:/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/, parseUrl:function (b) {
        ...
        x = function () {
            ...
            var D = !1;
            A && t && (t.url.indexOf(n) > -1 && !a.mobile.activePage.is(".ui-dialog") && (f.changeHash = !1, D = !0), q = (t.url || "") + n, j.activeIndex === 0 && q === j.initialDst && (q += n)), f.changeHash !== !1 && q && (j.ignoreNextHashChange = !0, h.set(q));
            var E = t ? b.jqmData("title") || b.children(":jqmData(role='header')").find(".ui-title").getEncodedText() : y;
            !!E && y === c.title && (y = E), b.jqmData("title") || b.jqmData("title", y), f.transition = f.transition || (x && !w ? t.transition : d) || (A ? a.mobile.defaultDialogTransition : a.mobile.defaultPageTransition), !x && !D && j.addNew(q, f.transition, y, r, f.role), c.title = j.getActive().title, a.mobile.activePage = b, f.reverse = f.reverse || x < 0, z(b, o, f.transition, f.reverse).done(function (c, d, e, h, i) {
            ...
            a(c).delegate("form", "submit", function (b) {
                ...
                a.mobile._handleHashChange(h.parseUrl(location.href).hash)
            }), a(c).bind("pageshow", A), a(b).bind("throttledresize", A)
        })
    }(a), function (a, b) {
        var e = {}, f = e, g = a(b), h = a.mobile.path.parseUrl(location.href), i = a.Deferred(), j = a.Deferred();
        a(c).ready(a.proxy(j, "resolve")), a(c).one("mobileinit", a.proxy(i, "resolve")), a.extend(e, {initialFilePath:function () {
            ...
            return{hash:a.mobile.path.parseUrl(location.href).hash || "#" + f.initialFilePath, title:c.title, initialHref:f.initialHref}
            ...
            var d, e, g = a.mobile.path.parseUrl(location.href).hash, h = a.mobile.path.isPath(g), i = h ? location.href : a.mobile.getDocumentUrl();
            ...
            g.bind("hashchange", f.onHashChange), g.bind("popstate", f.onPopState), location.hash === "" && history.replaceState(f.state(), c.title, location.href)
        ...
        a.fn.fieldcontain = function (a) {
            return this.addClass("ui-field-contain ui-body ui-br").contents().filter(
                function () {
        ...
        a.widget("mobile.collapsible", a.mobile.widget, {options:{expandCueText:" click to expand contents", collapseCueText:" click to collapse contents", collapsed:!0, heading:"h1,h2,h3,h4,h5,h6,legend", theme:null, contentTheme:null, inset:!0, mini:!1, initSelector:":jqmData(role='collapsible')"}, _create:function () {
            ...
            f.is("legend") && (f = a("<div role='heading'>" + f.html() + "</div>").insertBefore(f), f.next().remove()), j.length ? (d.theme || (d.theme = j.jqmData("theme") || a.mobile.getInheritedTheme(j, "c")), d.contentTheme || (d.contentTheme = j.jqmData("content-theme")), d.collapsedIcon || (d.collapsedIcon = j.jqmData("collapsed-icon")), d.expandedIcon || (d.expandedIcon = j.jqmData("expanded-icon")), d.iconPos || (d.iconPos = j.jqmData("iconpos")), j.jqmData("inset") !== b ? d.inset = j.jqmData("inset") : d.inset = !0, d.mini || (d.mini = j.jqmData("mini"))) : d.theme || (d.theme = a.mobile.getInheritedTheme(c, "c")), !d.inset || e.addClass("ui-collapsible-inset"), i.addClass(d.contentTheme ? "ui-body-" + d.contentTheme : ""), g = c.jqmData("collapsed-icon") || d.collapsedIcon || "plus", h = c.jqmData("expanded-icon") || d.expandedIcon || "minus", f.insertBefore(i).addClass("ui-collapsible-heading").append("<span class='ui-collapsible-heading-status'></span>").wrapInner("<a href='#' class='ui-collapsible-heading-toggle'></a>").find("a").first().buttonMarkup({shadow:!1, corners:!1, iconpos:c.jqmData("iconpos") || d.iconPos || "left", icon:g, mini:d.mini, theme:d.theme}), !d.inset || f.find("a").first().add(".ui-btn-inner", c).addClass("ui-corner-top ui-corner-bottom"), e.bind("expand collapse",
                ...
                }).trigger(d.collapsed ? "collapse" : "expand"), f.bind("tap",
                function (b) {
        ...
        a.widget("mobile.collapsibleset", a.mobile.widget, {options:{initSelector:":jqmData(role='collapsible-set')"}, _create:function () {
            ...
            d.theme || (d.theme = a.mobile.getInheritedTheme(c, "c")), d.contentTheme || (d.contentTheme = c.jqmData("content-theme")), c.jqmData("inset") !== b && (d.inset = c.jqmData("inset")), d.inset = d.inset !== b ? d.inset : !0, c.jqmData("collapsiblebound") || c.jqmData("collapsiblebound", !0).bind("expand collapse",
                function (b) {
        ...
        a.widget("mobile.listview", a.mobile.widget, {options:{theme:null, countTheme:"c", headerTheme:"b", dividerTheme:"b", splitIcon:"arrow-r", splitTheme:"b", inset:!1, initSelector:":jqmData(role='listview')"}, _create:function () {
            ...
            e.find("h1, h2, h3, h4, h5, h6").addClass("ui-li-heading").end().find("p, dl").addClass("ui-li-desc").end().find(".ui-li-aside").each(
                function () {
                    var b = a(this);
        ...
        a.mobile.listview.prototype.options.autodividers = !1, a.mobile.listview.prototype.options.autodividersSelector = function (a) {
            var b = a.find("a").text() || a.text() || null;
        ...
        a.fn.controlgroup = function (b) {
            ...
            return this.each(function () {
                var d = a(this), e = a.extend({direction:d.jqmData("type") || "vertical", shadow:!1, excludeInvisible:!0, mini:d.jqmData("mini")}, b), f = d.children("legend"), g = e.direction === "horizontal" ? ["ui-corner-left", "ui-corner-right"] : ["ui-corner-top", "ui-corner-bottom"], h = d.find("input").first().attr("type");
                d.wrapInner("<div class='ui-controlgroup-controls'></div>"), f.length && (a("<div role='heading' class='ui-controlgroup-label'>" + f.html() + "</div>").insertBefore(d.children(0)), f.remove()), d.addClass("ui-corner-all ui-controlgroup ui-controlgroup-" + e.direction), c(d.find(".ui-btn" + (e.excludeInvisible ? ":visible" : "")).not(".ui-slider-handle"), g), c(d.find(".ui-btn-inner"), g), e.shadow && d.addClass("ui-shadow"), e.mini && d.addClass("ui-mini")
            })
        }
    }(a), function (a, b) {
        a(c).bind("pagecreate create", function (b) {
        ...
        a.widget("mobile.popup", a.mobile.widget, {options:{theme:null, overlayTheme:null, shadow:!0, corners:!0, transition:"none", positionTo:"origin", tolerance:null, initSelector:":jqmData(role='popup')"}, _eatEventAndClose:function (a) {
            ...
            this._maybeRefreshTimeout() || (this.element.trigger("popupbeforeposition"), this._ui.container.removeClass("ui-selectmenu-hidden").offset(this._placementCoords(this._desiredCoords(d, d, "window"))).attr("tabindex", "0").focus(), this._resizeData = null, this._orientationchangeInProgress = !1)
        }, _handleWindowResize:function (a) {
            this._isOpen && this._maybeRefreshTimeout()
        }, _handleWindowOrientationchange:function (a) {
            this._orientationchangeInProgress || (this._ui.container.addClass("ui-selectmenu-hidden").removeAttr("style").removeAttr("tabindex"), this._orientationchangeInProgress = !0)
        }, _create:function () {
        ...
        }, _applyTheme:function (a, b) {
            var c = (a.attr("class") || "").split(" "), d = !0, e = null, f, g = String(b);
            while (c.length > 0) {
            ...
            b !== e && (a.removeClass("ui-body-" + e), b !== null && b !== "none" && a.addClass("ui-body-" + g))
        }, _setTheme:function (a) {
            this._applyTheme(this.element, a)
        }, _setOverlayTheme:function (b) {
            this._applyTheme(this._ui.screen, b), a.mobile.browser.ie && this._ui.screen.toggleClass("ui-popup-screen-background-hack", this._ui.screen.css("background-color") === "transparent" && this._ui.screen.css("background-image") === "none" && this._ui.screen.css("background") === d), this._isOpen && this._ui.screen.addClass("in")
            ...
            this._ui.container.addClass("ui-popup-active"), this._isOpen = !0, this._ui.container.attr("tabindex", "0").focus(), this.element.trigger("popupafteropen")
        }, _open:function (b) {
            var c, d;
            ...
            this._ui.container.removeAttr("tabindex"), this.element.trigger("popupafterclose")
        }, _close:function () {
            ...
            var d, e;
            typeof c.toPage == "string" ? d = c.toPage : d = c.toPage.jqmData("url"), d = a.mobile.path.parseUrl(d), e = d.pathname + d.search + d.hash, this._myUrl !== e && this._onHashChange(!0)
        }, _navHook:function (c) {
            function f() {
            ...
            c && a(b).unbind("navigate.popupBinder navigate.popup"), a.mobile.hashListeningEnabled && !c ? b.history.back() : this._onHashChange(), a.mobile.activePage.unbind("pagebeforechange.popup")
        }, push:function (a, b) {
            var c = this;
        ...
        a.widget("mobile.textinput", a.mobile.widget, {options:{theme:null, preventFocusZoom:/iPhone|iPad|iPod/.test(navigator.platform) && navigator.userAgent.indexOf("AppleWebKit") > -1, initSelector:"input[type='text'], input[type='search'], :jqmData(type='search'), input[type='number'], :jqmData(type='number'), input[type='password'], input[type='email'], input[type='url'], input[type='tel'], textarea, input[type='time'], input[type='date'], input[type='month'], input[type='week'], input[type='datetime'], input[type='datetime-local'], input[type='color'], input:not([type])", clearSearchButtonText:"clear text", disabled:!1}, _create:function () {
            ...
            if (e.is("textarea")) {
                ...
                }), a(c).one("pagechange", this._keyup), a.trim(e.val()) && a(b).load(this._keyup)
            }
            e.attr("disabled") && this.disable()
        }, _destroy:function () {
            a(b).unbind("load", this._keyup)
        }, disable:function () {
            var a;
        ...
        a.mobile.listview.prototype.options.filter = !1, a.mobile.listview.prototype.options.filterPlaceholder = "Filter items...", a.mobile.listview.prototype.options.filterTheme = "c", a.mobile.listview.prototype.options.filterCallback = function (a, b, c) {
            return a.toString().toLowerCase().indexOf(b) === -1
        }, a(c).delegate(":jqmData(role='listview')", "listviewcreate", function () {
            var b = a(this), c = b.data("listview");
            if (!c.options.filter)return;
            var d = a("<form>", {"class":"ui-listview-filter ui-bar-" + c.options.filterTheme, role:"search"}), e = a("<input>", {placeholder:c.options.filterPlaceholder}).attr("data-" + a.mobile.ns + "type", "search").jqmData("lastval", "").bind("keyup change",
                function () {
                    var d = a(this), e = this.value.toLowerCase(), f = null, g = d.jqmData("lastval") + "", h = !1, i = "", j;
                    d.jqmData("lastval", e), e.length < g.length || e.indexOf(g) !== 0 ? f = b.children() : f = b.children(":not(.ui-screen-hidden)");
                    if (e) {
                        for (var k = f.length - 1; k >= 0; k--)j = a(f[k]), i = j.jqmData("filtertext") || j.text(), j.is("li:jqmData(role=list-divider)") ? (j.toggleClass("ui-filter-hidequeue", !h), h = !1) : c.options.filterCallback(i, e, j) ? j.toggleClass("ui-filter-hidequeue", !0) : h = !0;
                        f.filter(":not(.ui-filter-hidequeue)").toggleClass("ui-screen-hidden", !1), f.filter(".ui-filter-hidequeue").toggleClass("ui-screen-hidden", !0).toggleClass("ui-filter-hidequeue", !1)
                    } else f.toggleClass("ui-screen-hidden", !1);
                    c._refreshCorners()
                }).appendTo(d).textinput();
            c.options.inset && d.addClass("ui-listview-filter-inset"), d.bind("submit",
                function () {
                    return!1
                }).insertBefore(b)
        })
        ...
        a.widget("mobile.slider", a.mobile.widget, {widgetEventPrefix:"slide", options:{theme:null, trackTheme:null, disabled:!1, initSelector:"input[type='range'], :jqmData(type='range'), :jqmData(role='slider')", mini:!1}, _create:function () {
            ...
            o.addClass("ui-slider"), f.addClass(j === "input" ? "ui-slider-input" : "ui-slider-switch").change(
                function () {
            ...
            }, a(c).bind("vmousemove", this._preventDocumentDrag), f.bind("vmouseup", a.proxy(e._checkedRefresh, e)), y.bind("vmousedown",
                function (a) {
            ...
            }, y.add(c).bind("vmouseup", this._sliderMouseUp), y.insertAfter(f), j === "select" && this.handle.bind({focus:function () {
            ...
            a(c).unbind("vmousemove", this._preventDocumentDrag), a(c).unbind("vmouseup", this._sliderMouseUp)
        ...
        var e = function (d) {
            ...
            d.isMultiple && (t = a("<a>", {text:d.options.closeText, href:"#", "class":"ui-btn-left"}).attr("data-" + a.mobile.ns + "iconpos", "notext").attr("data-" + a.mobile.ns + "icon", "delete").appendTo(p).buttonMarkup()), a.extend(d, {select:d.select, selectID:f, buttonId:k, menuId:l, thisPage:h, menuPage:m, label:g, selectOptions:i, isMultiple:j, theme:d.options.theme, listbox:n, list:o, header:p, headerTitle:q, headerClose:t, menuPageContent:r, menuPageClose:s, placeholder:"", build:function () {
                ...
                }), b.list.attr("role", "listbox").bind("focusin",
                    function (b) {
        ...
        a.widget("mobile.fixedtoolbar", a.mobile.widget, {options:{visibleOnPageShow:!0, disablePageZoom:!0, transition:"slide", fullscreen:!1, tapToggle:!0, tapToggleBlacklist:"a, button, input, select, textarea, .ui-header-fixed, .ui-footer-fixed", hideDuringFocus:"input, textarea, select", updatePagePadding:!0, trackPersistentToolbars:!0, supportBlacklist:function () {
            ...
            e.closest(".ui-page").bind("pagebeforeshow",
                function () {
        ...
        a.mobile.ajaxBlacklist && (a.mobile.ajaxEnabled = !1), e.addClass("ui-mobile ui-mobile-rendering"), setTimeout(h, 5e3), a.extend(a.mobile, {initializePage:function () {
            ...
            }), a.mobile.firstPage = b.first(), a.mobile.pageContainer = b.first().parent().addClass("ui-mobile-viewport"), g.trigger("pagecontainercreate"), a.mobile.showPageLoadingMsg(), h(), !a.mobile.hashListeningEnabled || !a.mobile.path.isHashValid(location.hash) || !a(location.hash + ':jqmData(role="page")').length && !a.mobile.path.isPath(location.hash) ? (a.mobile.path.isHashValid(location.hash) && (a.mobile.urlHistory.initialDst = a.mobile.path.parseUrl(location.href).hash.replace("#", "")), a.mobile.changePage(a.mobile.firstPage, {transition:"none", reverse:!0, changeHash:!1, fromHashChange:!0})) : g.trigger("hashchange", [!0])
